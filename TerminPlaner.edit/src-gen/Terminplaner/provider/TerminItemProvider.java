...
/**
 * This is the item provider adapter for a {@link Terminplaner.Termin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminItemProvider 
	 ...
	 * @generated
	 */
	public TerminItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Termin_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Termin_name_feature", "_UI_Termin_type"),
				 TerminplanerPackage.Literals.TERMIN__NAME,
				 true,
				 false,
				 false,
	...
	protected void addBeschreibungPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Termin_beschreibung_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Termin_beschreibung_feature", "_UI_Termin_type"),
				 TerminplanerPackage.Literals.TERMIN__BESCHREIBUNG,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Nutzer feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNutzerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Termin_nutzer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Termin_nutzer_feature", "_UI_Termin_type"),
				 TerminplanerPackage.Literals.TERMIN__NUTZER,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Termin"));
	}
	...
	public String getText(Object object) {
		String label = ((Termin)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Termin_type") :
			getString("_UI_Termin_type") + " " + label;
	}
